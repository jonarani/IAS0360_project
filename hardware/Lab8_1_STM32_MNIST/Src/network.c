...
#define AI_NETWORK_MODEL_SIGNATURE     "1a8a522a807e24e06c9fde726225aa1c"
...
#define AI_TOOLS_DATE_TIME   "Sat Dec 11 10:36:00 2021"
...
AI_STATIC ai_array dense_9_bias_array;   /* Array #3 */
AI_STATIC ai_array dense_9_weights_array;   /* Array #4 */
AI_STATIC ai_array conv2d_6_bias_array;   /* Array #5 */
AI_STATIC ai_array conv2d_6_weights_array;   /* Array #6 */
...
AI_STATIC ai_array conv2d_0_bias_array;   /* Array #13 */
AI_STATIC ai_array conv2d_0_weights_array;   /* Array #14 */
AI_STATIC ai_array conv2d_input_output_array;   /* Array #15 */
AI_STATIC ai_array conv2d_0_output_array;   /* Array #16 */
AI_STATIC ai_array conv2d_1_output_array;   /* Array #17 */
AI_STATIC ai_array conv2d_3_output_array;   /* Array #18 */
AI_STATIC ai_array conv2d_4_output_array;   /* Array #19 */
AI_STATIC ai_array conv2d_6_output_array;   /* Array #20 */
AI_STATIC ai_array dense_9_output_array;   /* Array #21 */
...
AI_STATIC ai_tensor dense_9_bias;   /* Tensor #3 */
AI_STATIC ai_tensor dense_9_weights;   /* Tensor #4 */
AI_STATIC ai_tensor conv2d_6_bias;   /* Tensor #5 */
AI_STATIC ai_tensor conv2d_6_weights;   /* Tensor #6 */
...
AI_STATIC ai_tensor conv2d_0_bias;   /* Tensor #13 */
AI_STATIC ai_tensor conv2d_0_weights;   /* Tensor #14 */
AI_STATIC ai_tensor conv2d_input_output;   /* Tensor #15 */
AI_STATIC ai_tensor conv2d_0_output;   /* Tensor #16 */
AI_STATIC ai_tensor conv2d_1_output;   /* Tensor #17 */
AI_STATIC ai_tensor conv2d_3_output;   /* Tensor #18 */
AI_STATIC ai_tensor conv2d_4_output;   /* Tensor #19 */
AI_STATIC ai_tensor conv2d_6_output;   /* Tensor #20 */
AI_STATIC ai_tensor conv2d_6_output0;   /* Tensor #21 */
AI_STATIC ai_tensor dense_9_output;   /* Tensor #22 */
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1536, 2, 1, 1), AI_STRIDE_INIT(4, 4, 6144, 12288, 12288),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 32, 32, 24), AI_STRIDE_INIT(4, 4, 4, 128, 4096),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 64, 16, 12), AI_STRIDE_INIT(4, 4, 4, 256, 4096),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 128, 4, 3), AI_STRIDE_INIT(4, 4, 4, 512, 2048),
  ...
  ai_network* net_ctx, const ai_buffer* activation_buffer)
{
...

  {
    ...
    conv2d_1_scratch0_array.data = AI_PTR(activations + 102656);
    conv2d_1_scratch0_array.data_start = AI_PTR(activations + 102656);
    conv2d_input_output_array.data = AI_PTR(NULL);
    conv2d_input_output_array.data_start = AI_PTR(NULL);
    conv2d_0_output_array.data = AI_PTR(activations + 4352);
    conv2d_0_output_array.data_start = AI_PTR(activations + 4352);
    conv2d_1_output_array.data = AI_PTR(activations + 0);
    conv2d_1_output_array.data_start = AI_PTR(activations + 0);
    conv2d_3_output_array.data = AI_PTR(activations + 24576);
    conv2d_3_output_array.data_start = AI_PTR(activations + 24576);
    conv2d_4_output_array.data = AI_PTR(activations + 8192);
    conv2d_4_output_array.data_start = AI_PTR(activations + 8192);
    conv2d_6_output_array.data = AI_PTR(activations + 20480);
    conv2d_6_output_array.data_start = AI_PTR(activations + 20480);
  ...
  ai_network* net_ctx, const ai_buffer* weights_buffer)
{
...

  {
    ...
    dense_9_bias_array.data = AI_PTR(weights + 567680);
    dense_9_bias_array.data_start = AI_PTR(weights + 567680);
    dense_9_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_9_weights_array.data = AI_PTR(weights + 555392);
    dense_9_weights_array.data_start = AI_PTR(weights + 555392);
    conv2d_6_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_6_bias_array.data = AI_PTR(weights + 554880);
    conv2d_6_bias_array.data_start = AI_PTR(weights + 554880);
    conv2d_6_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_6_weights_array.data = AI_PTR(weights + 259968);
    conv2d_6_weights_array.data_start = AI_PTR(weights + 259968);
    conv2d_4_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_4_bias_array.data = AI_PTR(weights + 259712);
    conv2d_4_bias_array.data_start = AI_PTR(weights + 259712);
    conv2d_4_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_4_weights_array.data = AI_PTR(weights + 112256);
    conv2d_4_weights_array.data_start = AI_PTR(weights + 112256);
    conv2d_3_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_3_bias_array.data = AI_PTR(weights + 112000);
    conv2d_3_bias_array.data_start = AI_PTR(weights + 112000);
    conv2d_3_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_3_weights_array.data = AI_PTR(weights + 38272);
    conv2d_3_weights_array.data_start = AI_PTR(weights + 38272);
